...
<div class="disdiv">
  ...
  <div class="orta"><?php
  $bilgi=$_GET["bilgi"];
  $eklelog=mysql_query("insert into log(idKullanici,Sayfa,Tarih) VALUES('$sid1','$bilgi. Kategorisine Girdi','$tarihlog')");
  $kitapsec=mysql_query("Select * from kitaplar where Kategori='$bilgi'");
